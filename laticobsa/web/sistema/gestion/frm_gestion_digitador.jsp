...
<body>
   <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#" onclick="consulcarteras_digitador();">Gestión Cliente</a></li>                    
   </ol>
...
<section class="panel panel-default well-lg margin">
    <div class="row">
        <div class="col-lg-3">
            ...
            <select class="form-control" id="idcartera"> </select>
            <label>Cédula/R.U.C.:</label>
            <input type="text"  class="form-control"id="b_identificacion" placeholder="Ingrese identificación"/>
            <label>Nombres de Deudor:</label>
            <input type="text"  class="form-control" id="b_nombres_completos" placeholder="Ingrese Nombres"/>
            
        </div>
        <div class="col-lg-3" hidden="true">
            <label hidden>Fecha Desde:</label>
            <input hidden="true" type="text"  class="form-control"id="fecha_desde_b" placeholder="2018-02-01"/>
            <label hidden>Fecha Hasta:</label>
            <input hidden="true" type="text"  class="form-control" id="fecha_hasta_b" placeholder="2018-02-27"/>
           
            <button  type='button' onclick="limpiar_cajas_texto();" class="btn btn-success btn-sm glyphicon glyphicon-trash "> Limpiar</button>
            <button  type='button' onclick="BuscarCliente2();" class="btn btn-primary btn-sm glyphicon glyphicon-search"> Buscar</button>
        </div>
        <div class="col-lg-3" >
    ...
    <div class="row" hidden="true">
        <div class="col-lg-12">
           ...
           <div class="col-sm-2" >
            ...
            <div class="col-sm-2" id="filtro_cartera" hidden="true">
                 <select class="form-control " name="cartera" required="required" id="cartera" onchange=""  >
            ...
            <!--Fin cambio Jimmy Guaranda -->
             ...
             <div class="col-sm-1" id="filtro_busqueta" hidden="true">                        
             ...
             <div class="col-sm-8" hidden="true">
                 ...
                 <form class="form-inline form-control-sm">
                     ...
                     <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control"id="ttvencidos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" >Pagos: $</span>
                        <input type="text" class="form-control" id="ttpagos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" >Saldos: $</span>
                        <input type="text" class="form-control" id="ttsaldos" placeholder="0.00" aria-describedby="sizing-addon3">
                      </div>
...
$('#fecha_desde_b').datetimepicker({   format:'Y-m-d' }); 
$('#fecha_hasta_b').datetimepicker({   format:'Y-m-d' }); 
...
$('#b_identificacion').validCampoFranz('0123456789');
$('#fecha_desde_b').validCampoFranz('0123456789-');
$('#fecha_hasta_b').validCampoFranz('0123456789-');
$('#b_nombres_completos').validCampoFranz('abcdefghijklmnñopqrstuvwxyzáéíóúüABCDEFGHIJKLMNÑOPQRSTUVWXYZÁÉÍÓÚÜ ');
consultaMisClientes();
